                ...
                <div className='row'>
                    <div className='col-12'> 
                        <div className='newsHeading'>
                            <p>News <span>And</span> Articles</p>
                        </div>
                    </div>
                </div>
                <div className='row'>
                        ...
                        <div className='newsMain'>
                            <div className='newsMain_body'>
                                ...
                                <div className='dateAndAdminNew'>
                                    <p><span>By: Admin</span> Category: Driving</p>
                                    <span>12/03/22</span>
                                </div>
                                ...
                                <div className='readmoreNews'>
                                    <a href='/' className='active'>Read More <FaArrowRight/></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='row'>
                    <div className='col-12'>
                        <div className='viewALLbtn'>
                            <button className='btn'>View All <RiArrowRightUpLine/></button>
                        </div>
                    </div>
                </div>
            </div>
